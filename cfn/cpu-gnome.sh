#!/bin/bash
# NICE DCV Setup - Ubuntu 24.04 (x86_64) - Console session (no GPU, compact)
#
# Boot flow:
...
# Console session: set graphical target, enable auto-create
...
# Phase 1b: DCV installation

# GNOME session environment files
cat > /home/ubuntu/.gnomerc << 'SCRIPT_EOF'
export XDG_CURRENT_DESKTOP=ubuntu:GNOME
export GNOME_SHELL_SESSION_MODE=ubuntu
export XDG_DATA_DIRS=/usr/share/gnome:/usr/local/share:/usr/share:/var/lib/snapd/desktop
SCRIPT_EOF
chown ubuntu:ubuntu /home/ubuntu/.gnomerc
chmod 644 /home/ubuntu/.gnomerc

cat > /etc/skel/.gnomerc << 'SCRIPT_EOF'
export XDG_CURRENT_DESKTOP=ubuntu:GNOME
export GNOME_SHELL_SESSION_MODE=ubuntu
export XDG_DATA_DIRS=/usr/share/gnome:/usr/local/share:/usr/share:/var/lib/snapd/desktop
SCRIPT_EOF
chmod 644 /etc/skel/.gnomerc
